...
inline Palette paletteFor(DisplayState s) {
  switch (s) {
    case STATE_IDLE:       return { rgb565(0x0a,0x0a,0x0f), rgb565(0xe0,0xe0,0xff), rgb565(0x40,0x40,0x60) };  // navy — quiet
    case STATE_SOON:       return { rgb565(0x0f,0x0e,0x06), rgb565(0xf4,0xd4,0x40), rgb565(0x60,0x50,0x18) };  // yellow — about to start
    case STATE_IMMINENT:   return { rgb565(0x0f,0x0a,0x04), rgb565(0xff,0xa8,0x30), rgb565(0x60,0x38,0x10) };  // orange — minutes away
    case STATE_IN_MEETING: return { rgb565(0x0f,0x08,0x08), rgb565(0xff,0x70,0x70), rgb565(0x60,0x10,0x10) };  // red — busy / do not disturb
    case STATE_ALL_CLEAR:  return { rgb565(0x06,0x0f,0x0a), rgb565(0x80,0xe0,0xa0), rgb565(0x20,0x50,0x30) };  // green — free for the day
